...
#IDX Domoticz
d_pack_current=2404					#Capteur Virtuel de type Ampere Monophasé
d_voltage=2284						#Capteur Virtuel Tension
d_remaining_capacity_p=2290			#Capteur Virtuel de type Pourcentage
d_remaining_capacity=2401			#Capteur Virtuel de type Custom Sensor. Nom de l'axe Ah
d_cycle_count=2402					#Capteur Virtuel de type Custom Sensor. Nom de l'axe ' ' (Espace)
#--------------------------------
